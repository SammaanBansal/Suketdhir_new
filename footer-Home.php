...
?>
    ...
    <script src="<?php echo get_bloginfo('template_directory');?>/assets/js/jquery/jquery.min.js "></script>
    <script src="<?php echo get_bloginfo('template_directory');?>/assets/js/jquery/bootstrap.min.js "></script>
